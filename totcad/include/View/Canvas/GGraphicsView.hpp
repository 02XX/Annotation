...
class GGraphicsView final : public QGraphicsView
{
    Q_OBJECT
public:
    explicit GGraphicsView(QGraphicsScene *scene, QWidget *parent = nullptr);

    void setActiveTool(GCanvasTool *tool);
    GCanvasTool *activeTool() const noexcept { return m_activeTool; }
    void showAll();
...
private:
    GCanvasTool *m_activeTool{nullptr};
