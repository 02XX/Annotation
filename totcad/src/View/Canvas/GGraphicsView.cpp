...
void GGraphicsView::setActiveTool(GCanvasTool *tool)
{
...
void GGraphicsView::zoomToSceneRect(const QRectF &rectangle, qreal viewportRatio)
{
...
void GGraphicsView::zoomBy(qreal factor, const QPoint &anchor)
{
    if (factor <= 0.0)
        return;
...
void GGraphicsView::panBy(const QPoint &delta)
{
