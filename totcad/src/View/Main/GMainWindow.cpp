...
void GMainWindow::createWorkspace()
{
    ...
    m_cadScene = new GGraphicsScene(this);
    m_cadScene->setDocuments(m_cadDocument, m_annotationDocument);
    m_cadView = new GGraphicsView(m_cadScene, this);
...
void GMainWindow::createMenusAndToolbars()
{
    ...
    connect(m_showAllAction, &QAction::triggered, m_cadView, &GGraphicsView::showAll);
...
void GMainWindow::connectWorkspace()
{
    ...
    connect(m_cadView, &GGraphicsView::mouseScenePositionChanged, this, [this](const QPointF &point) {
