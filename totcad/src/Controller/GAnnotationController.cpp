...
GAnnotationController::GAnnotationController(GAnnotationDocument *document,
...
void GAnnotationController::addType() { m_undoStack->push(new GAddTypeCommand(m_document)); }
